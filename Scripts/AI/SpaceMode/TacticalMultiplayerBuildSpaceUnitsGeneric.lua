...
function Definitions()
	...
	TaskForce = {
		...
		,"Rebel_X-Wing_Squadron | MC12_Corvette | CC_9600 | Quasar_Carrier | MC40_Cruiser | Liberator_Cruiser | Y-Wing_Squadron | A_Wing_Squadron | Corellian_Corvette | Corellian_Gunboat | JEDI_CRUISER_R | Marauder_Missile_Cruiser | Nebulon_B_Frigate | Alliance_Assault_Frigate | Calamari_Cruiser | Fleet_Com_Rebel_Team | B-Wing_Squadron | MC30_Frigate = 0,3"
		,"Tie_Fighter_Squadron | Star_Destroyer_I | Vindicator_Cruiser | Victory_Destroyer_I | Arquitens_Cruiser | Escort_Carrier | IPV4_SPC | Imperial_Customs_Corvette | Tie_Bomber_Squadron | Tartan_Patrol_Cruiser | JEDI_CRUISER_E | Broadside_Class_Cruiser | Acclamator_Assault_Ship | Victory_Destroyer | Interdictor_Cruiser | Star_Destroyer | Fleet_Com_Empire_Team | TIE_Defender_Squadron | TIE_Interceptor_Squadron | TIE_Phantom_Squadron = 0,3"
